...
export class HeroicActorData extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      side: new fields.StringField({ initial: "Heroic" }), calling: new fields.StringField(),
      triggers: new fields.SchemaField({ minor: new fields.StringField(), major: new fields.StringField(), defining: new fields.StringField() }),
      ...
      initiativeOverride: new fields.StringField(),
...
export class HeroicItemData extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      triggerMinor: new fields.StringField(), triggerMajor: new fields.StringField(), triggerDefining: new fields.StringField(),
