...
A native Foundry Virtual Tabletop system for **Heroic 5e v2.4**, built for Foundry VTT **14.364**. System version **1.3.1**.
...
- Native six-step Charactermancer that builds a complete Hero from the installed compendiums and automatically calculates derived statistics
